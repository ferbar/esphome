...
template<typename... Ts> class DBusSendAction : public Action<Ts...>, public Parented<DBus> {
  ...
  // std::list<std::string> braucht die set_* func noch extra
  ...
  void play(Ts... x) override {
    this->parent_->send(this->dbus_destination_.optional_value(x...), this->dbus_path_.optional_value(x...),
                        this->dbus_interface_.optional_value(x...), this->dbus_method_.optional_value(x...),
                        this->dbus_args_.optional_value(x...));
  }
};
